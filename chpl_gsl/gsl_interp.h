...
struct _gsl_interp_accel {
  size_t  cache;        /* cache of index   */
  size_t  miss_count;   /* keep statistics  */
  size_t  hit_count;
};
typedef struct _gsl_interp_accel gsl_interp_accel;
...
//
//} gsl_interp_type;
struct _gsl_interp_type;
typedef struct _gsl_interp_type gsl_interp_type;
...
typedef struct _gsl_interp gsl_interp;
