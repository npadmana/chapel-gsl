...
struct _gsl_integration_workspace
  {
    size_t limit;
    size_t size;
    size_t nrmax;
...
typedef struct _gsl_integration_workspace
...
struct _gsl_integration_qaws_table
{
  double alpha;
  double beta;
  int mu;
...
typedef struct _gsl_integration_qaws_table
